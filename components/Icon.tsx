...
/**
 * Icons from hticonstps://.getbootstrap.com/
 *
 * To add an icon, copy/paste the <path> element from the SVG source listed on the icons page.  (E.g. )
 */

export default function Icon({ name, size = '1em', color = 'currentColor', ...props } : {name : string, size ?: string, color ?: string} & HTMLAttributes<SVGElement>) {
  let path;
  switch (name) {
    case 'card-fill':
      path = <>
